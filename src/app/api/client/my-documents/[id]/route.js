//FILE: src/app/api/client/my-documents/[id]/route.js
  ...
  try {
    ...
    const transformedDoc = {
      ...
      uploadedBy: document.uploadedBy
        ...
        : null,
      accessLevel: document.isCompanyDocument
        ? "general"
        : document.targetClient &&
          document.targetClient._id.toString() === clientId.toString()
        ? "specific"
        : document.specificClients &&
          document.specificClients.some(
