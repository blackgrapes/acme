...
export function PresenceSection() {
  return (
    <section className="container mx-auto px-2 py-8 sm:py-14">
      {/* Heading */}
      ...
      {/* Two Column Layout */}
      <div className="grid md:grid-cols-2 gap-16 sm:gap-20 lg:gap-28 items-center max-w-8xl mx-auto">
        {/* Left: Image */}
          ...
          <div className="grid grid-rows-3 gap-4 sm:gap-6">
            ...
            <div className="flex items-center p-4 sm:p-6 rounded-2xl bg-gradient-to-tr from-primary/10 to-primary/5 shadow-md hover:shadow-lg transition-all">
              ...
              <div className="ml-4 flex-1 text-left">
                ...
                <p className="text-secondary text-xs sm:text-sm mt-1">
                  A decade of trust, delivering reliable and consistent service
                  across the city.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center p-4 sm:p-6 rounded-2xl bg-gradient-to-tr from-primary/10 to-primary/5 shadow-md hover:shadow-lg transition-all">
              ...
              <div className="ml-4 flex-1 text-left">
                ...
                <p className="text-secondary text-xs sm:text-sm mt-1">
                  Trusted by hundreds of businesses and individuals to keep them
                  safe and secure.
                </p>
              </div>
            </div>
